package com.dc.todomvvmretrofitcoroutinekoin.utils.custombottomsheet
...
import com.dc.todomvvmretrofitcoroutinekoin.databinding.CustomBottomSheetChildBinding
import com.dc.todomvvmretrofitcoroutinekoin.databinding.CustomBottomSheetParentBinding
...
class CustomBottomSheet(
    ...
    inner class RecyclerViewAdapter(private val list: ArrayList<BottomSheetModel>) :
        ...
        inner class RecyclerViewViewHolder(private val binding: CustomBottomSheetChildBinding) :
            ...
            fun setDataToViews(position: Int) {
                ...
                binding.childText.text = list.get(position).name
            }
